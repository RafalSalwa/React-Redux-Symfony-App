...
#[AsCommand(
    name: 'newsletter:sendout:newcomers',
    description: 'Add a short description for your command',
)]
class NewsletterSendoutNewcomersCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('period', null, InputOption::VALUE_OPTIONAL, 'No of days back to look for users', self::DAYS_BACK_TO_CHECK)
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($users as $user) {
            $email = (new Email())
                    ...
                    ->html('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec id interdum nibh.
        ...
        $io->success('Newsletter sent to ' . count($users) . ' users.');
